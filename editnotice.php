...
if (isset($_SESSION["username"])) {
    if ($_SESSION["username"] == "admin") { ?>
						...
						<li class="nav-item">
							<a class="nav-link active" aria-current="page" href="addnotice.php">Notices</a>
						</li>
						<li class="nav-item">
...
if (isset($_SESSION["username"])) { ?>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu bg-danger" aria-labelledby="navbarDropdownMenuLink">
								<li><a class="dropdown-item bg-danger text-white fw-bold text-center" href="addnotice.php?logout='1'">logout</a></li>
							</ul>
						</li>
						<?php
} else { ?>
				...
				$id = $_GET['id'];
				$sql2 = "SELECT * from notices where id = '$id'";
				$res2 = mysqli_query($conn, $sql2);
				$row2 = mysqli_fetch_assoc($res2);
				$noticeheading = $row2["noticeheading"];
...
?>
		...
		<div class="row">
			<div class="col-2"></div>
			<div class="col-8">
				<h1 class="text-center m-2 mb-4 p-1 border border-dark border-3 border-top-0 border-end-0 rounded">Insert Notice</h1>
			</div>
			<div class="col-2"></div>
		</div>
		<div class="row">
			...
			<div class="col-8">
				<form class="row g-3 m-2 border-dark border-3 rounded px-2" name="form" method="post" action="" enctype="multipart/form-data">
					...
					<div class="col-md-6 mb-3">
						<label for="exampleFormControlInput1" class="form-label fw-bold">Notice Heading</label>
						<input type="text" class="form-control" id="exampleFormControlInput1" name="heading" placeholder="Enter Heading" required value="<?php echo $noticeheading ?>">
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-12 mb-3">
						...
						<textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="details" placeholder="Enter Details" required><?php echo $details ?></textarea>
					</div>

...
?>
		...
		<div class="row">
			<div class="col-2"></div>
			<div class="col-8">
				<h1 class="text-center m-2 mb-4 p-1 border border-dark border-3 border-top-0 border-end-0 rounded">Insert Faculty</h1>
			</div>
			<div class="col-2"></div>
		</div>
		<div class="row">
				...
				<div class="row table-responsive m-3">
					<table class="table table-lg align-middle">
						...
						<tbody>
							<?php
$count = 1;
$sel_query = "Select * from faculty ORDER BY id desc;";
$result = mysqli_query($conn, $sel_query);
while ($row = mysqli_fetch_assoc($result)) { ?>
							<tr>
								<td><?php echo $count; ?></td>
								<td><?php echo '<img src="facultyimage/' . $row["image"] . '" alt="HTML5 Icon" style="width:128px;height:128px">'; ?></td>

				...
				<div class="row table-responsive m-3">
					<table class="table table-lg align-middle">
						...
						<tbody>
							<?php
$count = 1;
$sel_query = "Select * from directory ORDER BY id desc;";
...
while ($row = mysqli_fetch_assoc($result)) { ?>
							<tr>
								...
								<td>
									<a class="btn btn-danger" href="deleteDirectory.php?id=<?=$row["id"] ?>">Delete</a>
									<a class="btn btn-danger" href="editdirectory.php?id=<?=$row["id"] ?>">Edit</a>
								</td>
							</tr>
							<?php $count++;
}
